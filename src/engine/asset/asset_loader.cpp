...
Shader AssetLoader::LoadShaderFromPath(const std::string &vertexPath, const std::string &fragPath) {
...
Sprite AssetLoader::LoadSpriteFromPath(const std::string &path) {
    return Sprite(path);
}
...
Font AssetLoader::LoadFontFromPath(const std::string &path) {
    // FreeType
    // --------
    FT_Library ft;
