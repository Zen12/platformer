...
blender --background "$DIR/ground2.blend" --python-expr "
import bpy
...
bpy.ops.export_scene.gltf(filepath='$OUT_DIR/ground2.glb', export_format='GLB', export_yup=True, export_skins=False, export_animations=False)
print('Exported: $OUT_DIR/ground2.glb')
" 2>&1 | grep -v "Not freed"

python3 "$ROOT/mcp_tools/import.py" "$OUT_DIR/ground2.glb"
echo "Done!"
